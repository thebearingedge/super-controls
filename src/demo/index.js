...
//
// const Input = createControl({ name, label, ...props }) =>
...
// })
//
// const Select = createControl({ name, label, children, ...props }) =>
//   <div className='form-group'>
//     <label htmlFor={name}>{ label }</label>
...
// })
//
// const Radio = createControl({ children, ...props }) =>
//   <div className='form-check'>
//     <label className='form-check-label'>
//       <input type='radio' checked={console.log(props.checked)} className='form-check-input' {...props}/>
//       { children }
//     </label>
//   </div>
// )({
...
// })
//
// const TextArea = createControl({ name, label, ...props }) =>
//   <div className='form-group'>
//     <label htmlFor={name}>{ label }</label>
...
// })
//
// const Checkbox = createControl({ name, label, ...props }) =>
//   <div className='form-check'>
//     <label className='form-check-label'>
...
//     <Input id type='text' name='name' label='Name' autoFocus/>
